...
int main(void) {
    ...
    alloc_tex_normal = MmAllocateContiguousMemoryEx(tex_normal_pitch * tex_normal_height, 0, 0x03FFAFFF, 0, 0x404);
    ...
    while(1) {
        ...
        if(input_button_down(SDL_CONTROLLER_BUTTON_DPAD_DOWN))
            ...
            v_light_pos.z -= 0.02f;
        else if(input_button_down(SDL_CONTROLLER_BUTTON_DPAD_LEFT))
            v_light_pos.x -= 0.02f;
